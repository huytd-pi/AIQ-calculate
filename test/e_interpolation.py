...
counties = gpd.read_file("../shpHaNoi/HaNoi_2.shp")
...
rainfall = pd.read_csv("../out/data/DataIDW/2021-01-01.csv",encoding = 'latin1')
...
x_rain = rainfall["Longtitude"]
y_rain = rainfall["Latitude"]
...
value_rain = list(rainfall["AQI 24h"])
...
counties_buffer = counties.buffer(1)
